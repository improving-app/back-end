...
object OrganizationByChildrenProjection {
  ...
  private def createProjectionFor(
    ...
    CassandraProjection.atLeastOnce(
      projectionId = ProjectionId("ChildrenByOrganizationProjection", tag),
      sourceProvider,
      handler = () => new OrganizationByChildrenProjectionHandler(tag, system, repository)
    )
  }
