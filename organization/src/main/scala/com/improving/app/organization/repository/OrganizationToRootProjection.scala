...
object OrganizationToRootProjection {
  ...
  private def createProjectionFor(
    ...
    CassandraProjection.atLeastOnce(
      projectionId = ProjectionId("OrganizationToRootProjection", tag),
      sourceProvider,
      handler = () => new OrganizationToRootProjectionHandler(tag, system, repository)
    )
  }
