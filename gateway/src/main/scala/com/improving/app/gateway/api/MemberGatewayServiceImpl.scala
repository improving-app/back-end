...
import com.improving.app.member.domain.{GetMemberInfo, MemberData, MemberEventResponse}
import com.improving.app.tenant.api.MemberGatewayService

import scala.concurrent.duration.DurationInt
import scala.concurrent.{ExecutionContext, Future}
import scala.language.postfixOps

class MemberGatewayServiceImpl(implicit val system: ActorSystem[_]) extends MemberGatewayService {
