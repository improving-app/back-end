FROM adoptopenjdk/openjdk13:alpine-slim as stage0
LABEL snp-multi-stage="intermediate"
LABEL snp-multi-stage-id="f096b05a-778f-4a67-9b12-86ed3c62ed2a"
WORKDIR /opt/docker
COPY 2/opt /2/opt
COPY 4/opt /4/opt
USER root
...
FROM adoptopenjdk/openjdk13:alpine-slim as mainstage
USER root
